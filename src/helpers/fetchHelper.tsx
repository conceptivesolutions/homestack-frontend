...
/**
 * Executes a PATCH request with pre-set authorization header, if token was given
 *
 * @param url URL to fetch
 * @param token Bearer-Token for authorization - or NULL if no Header should be set
 * @param body Body to send with this request
 * @constructor
 */
export function PATCH(url: string, token: string | null, body?: string): Promise<Response>
{
  let headers = {
    "Content-Type": "application/json; charset=UTF-8",
  };
